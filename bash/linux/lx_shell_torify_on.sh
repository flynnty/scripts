...
#  Header                                                                      #
################################################################################
# Filename:     lx_shell_torify_on.sh
# Author:       tflynn
# Date:         20221223
# Copyright:    Tony Flynn
#
# Description:| Torify active for all shell commands
#             | 
#
# Input:      | None
# Output:     | None
...
print_help()
{
  ...
  echo "Description:| Enable torify for all shell commands                  "
  echo "            |                                                       "
  echo "            |                                                       "
  echo "____________________________________________________________________"
  echo "Usage:      | lx_shell_torfy_on                                     " 
  echo "____________________________________________________________________"
  echo "Input:      | None                                                  "
  echo "____________________________________________________________________"
  echo "Output:     | None                                                  "
...
lx_shell_torify_on()
{
  ...
  echo "$TORSOCKS_ON" >>"$BASHRC_FILE" 2>/dev/null
