...
#  Header                                                                      #
################################################################################
# Filename:     ff_window_maximize.sh
# Author:       tflynn
# Date:         20221223
# Copyright:    Tony Flynn
# Description:  Maximize firefox browser with ID
#
# Input:        ID of browser to minimize
...
ff_window_maximize()
{
  xdotool windowactivate --sync "${FF_BROWSER_ID}" key --delay 20 --clearmodifiers "super+Up" 2>/dev/null
